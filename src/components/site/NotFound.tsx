...
export function NotFound() {
  return (
    <div className="min-h-screen bg-brand-cream flex flex-col items-center justify-center px-6 text-center">
      <p className="font-display text-[120px] font-bold leading-none text-brand-brown">
        404
      </p>
      ...
      <p className="mt-3 max-w-md text-[14px] font-light text-brand-dark/70">
        The link might be broken or the page may have moved. Try the home page
        or browse mentors to keep going.
      </p>
