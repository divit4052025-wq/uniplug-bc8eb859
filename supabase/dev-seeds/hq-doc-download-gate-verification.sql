...
('da000000-0000-0000-0000-00000000000a','authenticated','authenticated','a2-m@example.com',crypt('x',gen_salt('bf')),now(),'{"provider":"email"}','{"role":"mentor","full_name":"A2 Mentor","university":"U","course":"C","year":"3rd Year"}','','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
('da000000-0000-0000-0000-00000000000b','authenticated','authenticated','a2-m2@example.com',crypt('x',gen_salt('bf')),now(),'{"provider":"email"}','{"role":"mentor","full_name":"A2 Mentor2","university":"U","course":"C","year":"2nd Year"}','','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
