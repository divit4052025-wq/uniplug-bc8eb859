...
( 'd8000000-0000-0000-0000-0000000000aa'::uuid, 'authenticated','authenticated','p8-mentor-a@example.com',
  crypt('x',gen_salt('bf')), now(), '{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor A','university','IIT Bombay','course','CS','year','3rd Year'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'd8000000-0000-0000-0000-0000000000bb'::uuid, 'authenticated','authenticated','p8-mentor-b@example.com',
  crypt('x',gen_salt('bf')), now(), '{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor B','university','IIT Delhi','course','ME','year','2nd Year'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'd8000000-0000-0000-0000-0000000000cc'::uuid, 'authenticated','authenticated','p8-mentor-c@example.com',
  crypt('x',gen_salt('bf')), now(), '{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor C','university','Stanford University','course','Econ','year','Final Year'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'd8000000-0000-0000-0000-0000000000dd'::uuid, 'authenticated','authenticated','p8-mentor-d@example.com',
  crypt('x',gen_salt('bf')), now(), '{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor D','university','MIT','course','Physics','year','1st Year'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'd8000000-0000-0000-0000-0000000000ee'::uuid, 'authenticated','authenticated','p8-mentor-e@example.com',
  crypt('x',gen_salt('bf')), now(), '{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor E','university','Yale','course','History','year','3rd Year'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000')
