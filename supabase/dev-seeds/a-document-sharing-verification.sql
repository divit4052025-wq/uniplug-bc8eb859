...
('da000000-0000-0000-0000-00000000000a','authenticated','authenticated','a-m@example.com',crypt('x',gen_salt('bf')),now(),'{"provider":"email"}','{"role":"mentor","full_name":"A Mentor","university":"U","course":"C","year":"3rd Year"}','','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
('da000000-0000-0000-0000-00000000000b','authenticated','authenticated','a-m2@example.com',crypt('x',gen_salt('bf')),now(),'{"provider":"email"}','{"role":"mentor","full_name":"A Mentor2","university":"U","course":"C","year":"2nd Year"}','','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
...
('da000000-0000-0000-0000-00000000000d','authenticated','authenticated','a-mb@example.com',crypt('x',gen_salt('bf')),now(),'{"provider":"email"}','{"role":"mentor","full_name":"A MentorB","university":"U","course":"C","year":"4th Year"}','','','','',now(),now(),'00000000-0000-0000-0000-000000000000')
