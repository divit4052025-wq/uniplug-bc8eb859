...
( 'e2000000-0000-0000-0000-0000000000aa'::uuid,'authenticated','authenticated','p2-mentor-a@example.com',
  crypt('x',gen_salt('bf')),now(),'{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor A','university','IIT Bombay','course','CS','year','3rd Year','college_email','a@gmail.com'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'e2000000-0000-0000-0000-0000000000bb'::uuid,'authenticated','authenticated','p2-mentor-b@example.com',
  crypt('x',gen_salt('bf')),now(),'{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor B','university','IIT Delhi','course','ME','year','2nd Year','college_email','b@gmail.com'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'e2000000-0000-0000-0000-0000000000cc'::uuid,'authenticated','authenticated','p2-mentor-c@example.com',
  crypt('x',gen_salt('bf')),now(),'{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor C','university','IIT Madras','course','Econ','year','Final Year','college_email','c@iitb.ac.in'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'e2000000-0000-0000-0000-0000000000dd'::uuid,'authenticated','authenticated','p2-mentor-d@example.com',
  crypt('x',gen_salt('bf')),now(),'{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor D','university','MIT','course','Physics','year','1st Year','college_email','d@gmail.com'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'e2000000-0000-0000-0000-0000000000ee'::uuid,'authenticated','authenticated','p2-mentor-e@example.com',
  crypt('x',gen_salt('bf')),now(),'{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor E','university','Yale','course','History','year','3rd Year','college_email','e@gmail.com'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'e2000000-0000-0000-0000-0000000000ff'::uuid,'authenticated','authenticated','p2-mentor-f@example.com',
  crypt('x',gen_salt('bf')),now(),'{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor F','university','NIT Trichy','course','EE','year','2nd Year','college_email','f@gmail.com'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'e2000000-0000-0000-0000-0000000000a1'::uuid,'authenticated','authenticated','p2-mentor-g@example.com',
  crypt('x',gen_salt('bf')),now(),'{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor G','university','NIT Surat','course','CE','year','1st Year','college_email','g@gmail.com'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
( 'e2000000-0000-0000-0000-0000000000a2'::uuid,'authenticated','authenticated','p2-mentor-h@example.com',
  crypt('x',gen_salt('bf')),now(),'{"provider":"email"}'::jsonb,
  jsonb_build_object('role','mentor','date_of_birth','2000-01-01','full_name','Mentor H','university','NIT Goa','course','IT','year','4th Year','college_email','h@gmail.com'),
  '','','','',now(),now(),'00000000-0000-0000-0000-000000000000')
