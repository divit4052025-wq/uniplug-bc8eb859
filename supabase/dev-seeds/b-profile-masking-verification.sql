...
('db000000-0000-0000-0000-0000000000a1','authenticated','authenticated','b-m1@example.com',crypt('x',gen_salt('bf')),now(),'{"provider":"email"}','{"role":"mentor","full_name":"Riya Sharma","university":"IIT Bombay","course":"CS","year":"3rd Year","date_of_birth":"2000-01-01"}','','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
('db000000-0000-0000-0000-0000000000a2','authenticated','authenticated','b-m2@example.com',crypt('x',gen_salt('bf')),now(),'{"provider":"email"}','{"role":"mentor","full_name":"Arjun Mehta","university":"IIT Delhi","course":"ME","year":"2nd Year","date_of_birth":"2000-01-01"}','','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
