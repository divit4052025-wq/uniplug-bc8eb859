...
('c3000000-0000-0000-0000-00000000000a','authenticated','authenticated','c3-m@example.com',crypt('x',gen_salt('bf')),now(),'{"provider":"email"}','{"role":"mentor","full_name":"C3 M","university":"U","course":"C","year":"3rd Year"}','','','','',now(),now(),'00000000-0000-0000-0000-000000000000'),
